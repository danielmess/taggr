...
public class JDBCtagDAO implements TagDAO {
    ...
    public JDBCtagDAO(BasicDataSource dataSource) {
    ...
    public Set<Tag> createTagsSetFromCSV(String tagscsv, User user){
        ...
        for(String tagname: tagnames){
            ...
            theTag.setUserID(user.getUser_id());
    ...
    public List<TagIndexDTO> getUserTagIndex(User user){
        ...
        SqlRowSet results = jdbcTemplate.queryForRowSet(sqlTagIndexQuery, user.getUser_id());
    ...
    public Tag findTagByName(String tag, User user){
        ...
        SqlRowSet results = jdbcTemplate.queryForRowSet(sqlQuery, tag, user.getUser_id());
